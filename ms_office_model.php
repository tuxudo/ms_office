...
class Ms_office_model extends \Model
{
    public function __construct($serial = '')
    {
        ...
        $this->rs['word_mas'] = '';
        $this->rs['word_office_generation'] = 0;
        $this->rs['teams_app_version'] = '';
        $this->rs['teams_mas'] = '';
        $this->rs['msupdate_check_enabled'] = 0;
        $this->rs['company_portal_app_version'] = '';
        $this->rs['edge_app_version'] = '';
        $this->rs['atp_defender_app_version'] = '';
        $this->rs['yammer_app_version'] = '';
        $this->rs['o365_user_accounts'] = '';
        $this->rs['copilot_app_version'] = '';
